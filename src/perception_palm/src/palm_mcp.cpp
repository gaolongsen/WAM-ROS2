...
const string IR_TOPIC = "ir/range";
const string FIXED_FRAME_TOPIC = "fixed_frame";

bool ppalm_ros_wrapper::led_control(std_srvs::SetBool::Request &req, std_srvs::SetBool::Response &res){
...
bool ppalm_ros_wrapper::laser_control(std_srvs::SetBool::Request &req, std_srvs::SetBool::Response &res){
